...
DBM.AddOns.Hakkar = { 
	...
	["OnCombatStart"] = function(delay)
		DBM.StartStatusBarTimer(600, "Enrage", "Interface\\Icons\\Spell_Shadow_UnholyFrenzy");
		DBM.StartStatusBarTimer(90, "Life Drain", "Interface\\Icons\\Spell_Shadow_LifeDrain02");
		DBM.StartStatusBarTimer(17, "Hakkar_MC", "Interface\\Icons\\Spell_Shadow_ShadowWordDominate");
