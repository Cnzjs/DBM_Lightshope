...
DBM.AddOns.Ayamiss = { 
	...
	["OnCombatStart"] = function(delay)
		DBM.StartStatusBarTimer(11, "5_Offer", "Interface\\Icons\\Spell_Shadow_Haunting");
	end,
	["OnEvent"] = function(event, arg1) 
			...
			if ( sArg1 and sArg2 ) then
				...
				DBM.EndStatusBarTimer("5_Offer");
				DBM.StartStatusBarTimer(15, "5_Offer", "Interface\\Icons\\Spell_Shadow_Haunting");
			end
	end,		
};
