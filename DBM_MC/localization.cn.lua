...
-- 1. Lucifron
	...
	DBM_SBT["1_Curse"]				= "鲁西弗隆的诅咒";
	DBM_SBT["1_Impending Doom"]		= "末日降临";
...
-- 2. Magmadar
	...
	DBM_MAGMADAR_FRENZY_WARNING		= "*** 狂乱 - 立即宁神！ ***";
	DBM_MAGMADAR_FEAR_WARNING1		= "*** 恐慌 - 30秒后再次施放 ***";
	DBM_MAGMADAR_FEAR_WARNING2		= "*** 恐慌 - 3秒后施放 ***";
	DBM_MAGMADAR_FRENZY 			= "goes into a killing frenzy!";
...
-- 3. Gehennas
	...
	DBM_SBT["3_Curse"]				= "基赫纳斯的诅咒";
	DBM_SBT["3_Firerain"]			= "火焰之雨";
...
-- 5. Geddon
	...
	DBM_BARON_INFERNO_WARNING	= "*** 地狱火 - 近战远离 ***";
	DBM_BARON_BOMB_REGEXP	 	= "([^%s]+)受([^%s]+)活化炸弹效果的影响。";
	DBM_BARON_INFERNO			= "迦顿男爵获得了地狱火的效果。";
	DBM_BARON_IGNITEMANA_EXPR	= "受到了点燃法力效果的影响";
	DBM_BARON_IGNITEMANA_DONE	= "*** 已施放点燃法力 - 请出来打 ***";
	DBM_BARON_IGNITEMANA_ANNOUNCE = "*** 即将点燃法力 - 注意卡视野 ***";
	
	DBM_SBT["5_Nextinferno"]	= "下一次地狱火";
	DBM_SBT["5_Inferno"]		= "地狱火";
	DBM_SBT["5_Bomb"]			= "活化炸弹";
	DBM_SBT["5_Ignitemana"]		= "点燃法力";
...
-- 6. Shazzrah
	...
	DBM_SHAZZRAH_DEADEN_WARN		= "*** 衰减魔法 - 牧师萨满驱散 ***";
...
-- 9. Majordomo
	...
	DBM_MAJORDOMO_COMBAT_START_YELL = "Reckless mortals, none may challenge the sons of the living flame!";
	DBM_DOMO_SHIELD_WARNING1 	= "*** 伤害反射 - 近战注意 ***";
	DBM_DOMO_SHIELD_WARNING2 	= "*** 魔法反射 - 法系停手 ***";
	DBM_DOMO_SHIELD_FADED		= "*** %s消失 - 可以打了 ***";
	DBM_DOMO_DAMAGE_SHIELD		= "伤害反射";
	DBM_DOMO_MAGIC_REFLECTION	= "魔法反射";
	DBM_DOMO_GAIN_MAGIC			= "获得了魔法反射的效果。";
	DBM_DOMO_GAIN_DAMAGE		= "获得了伤害反射护盾的效果。";
	DBM_DOMO_FADE_MAGIC 		= "魔法反射效果从烈焰行者([^%s]+)身上消失。";
	DBM_DOMO_FADE_DAMAGE	 	= "伤害反射护盾效果从烈焰行者([^%s]+)身上消失。";
	DBM_DOMO_SHIELD_WARNING_NEW	= "*** 反射护盾 - 5秒后再次施放 ***";
	DBM_DOMO_MOB_DEATH			= "烈焰行者精英死亡";
	DBM_DOMO_MOB_DEATH2			= "烈焰行者医师死亡";
	DBM_DOMO_MOB_DEATH_ANNOUNCE	= "*** %s/8 小怪已死 ***";

	DBM_SBT["Damage shield"]	= "伤害反射";
	DBM_SBT["Magic reflection"]	= "魔法反射";
	DBM_SBT["Shield CD"]		= "下一次护盾";
...
-- 10. Ragnaros
	...
	DBM_RAGNAROS_EMERGE_WARN		= "*** %s%s后现身 ***";
	DBM_RAGNAROS_WRATH_WARN1		= "*** 已经击飞 - 近战开打 ***";
	DBM_RAGNAROS_WRATH_WARN2		= "*** 即将击飞 - 近战远离 ***";
	DBM_RAGNAROS_HITS				= "拉格纳罗斯([hitscr]+)([^%s]+)造成(%d+)";
	DBM_RAGNAROS_WRATH	 			= "TASTE THE FLAMES OF SULFURON!";
	DBM_RAGNAROS_SUBMERGE 			= "COME FORTH, MY SERVANTS! DEFEND YOUR MASTER!";
	DBM_RAGNAROS_SUMMONED			= "Imprudent whelps! You've rushed headlong to your own deaths! See now, the master stirs!";
	DBM_RAGNAROS_MOBDEAD			= "烈焰之子死亡";
	DBM_RAGNAROS_MOBDEAD_ANNOUNCE	= "*** %s/8 小怪已死 ***";
	
	DBM_SBT["Wrath of Ragnaros"]	= "击飞";
	DBM_SBT["Submerge"]				= "下潜";
	DBM_SBT["Emerge"]				= "现身";
	DBM_SBT["10_Fight"]				= "BOSS激活";
