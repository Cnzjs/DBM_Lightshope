DBM.AddOns.Vaelastrasz = {
	...
	["OnCombatStart"] = function()
		DBM.StartRepeatingStatusBarTimer(15, "2_Adrenaline", "Interface\\Icons\\INV_Gauntlets_03");
	end,
	["OnCombatEnd"] = function()
		if( DBM.AddOns.Vaelastrasz.Options.SetIcon ) then
			DBM.CleanUp();
		end
		DBM.StartStatusBarTimer(15, "2_Adrenaline", "Interface\\Icons\\INV_Gauntlets_03");
	end,		
	["OnEvent"] = function(event, arg1)
		...
		elseif (event == "CHAT_MSG_MONSTER_YELL") and string.find (arg1,DBM_VAEL_START) then
			DBM.StartStatusBarTimer(35.5, "2_Active", "Interface\\Icons\\INV_Misc_Head_Dragon_01");
		end
	end,
};
