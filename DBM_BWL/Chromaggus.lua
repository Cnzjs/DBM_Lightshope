DBM.AddOns.Chromaggus = {
	...
	["OnCombatStart"] = function(delay)
		DBM.Schedule(28 - delay, "DBM.AddOns.Chromaggus.OnEvent", "BreathWarning", 1);
		DBM.Schedule(58 - delay, "DBM.AddOns.Chromaggus.OnEvent", "BreathWarning", 2);
		DBM.StartStatusBarTimer(30, "Breath 1", "Interface\\Icons\\Spell_Magic_PolymorphChicken");
		DBM.StartStatusBarTimer(60, "Breath 2", "Interface\\Icons\\Spell_Nature_Polymorph");
	...
	["OnEvent"] = function(event, arg1)
		if event == "CHAT_MSG_SPELL_CREATURE_VS_CREATURE_DAMAGE" and arg1 then
			...
			if breath == "时间流逝" then --fix me!
				breath = "时间流逝";
			elseif breath == "腐蚀酸液" then
				breath = "腐蚀酸液";
			elseif breath == "点燃躯体" then
				breath = "点燃躯体";
			elseif breath == "焚烧" then
				breath = "焚烧";
			elseif breath == "冰霜灼烧" then
				breath = "冰霜灼烧";
			end
			...
			if breath then
				...
				DBM.Schedule(0, "DBM.AddOns.Chromaggus.OnEvent", "StartNewBreathTimer", breath);
			end
		elseif event == "StartNewBreathTimer" and arg1 then
			...
			if arg1 == DBM.AddOns.Chromaggus.Breath1 then
				DBM.Schedule(58, "DBM.AddOns.Chromaggus.OnEvent", "BreathWarning", 1);
			elseif arg1 == DBM.AddOns.Chromaggus.Breath2 then
				DBM.Schedule(58, "DBM.AddOns.Chromaggus.OnEvent", "BreathWarning", 2);
			end
		...
		elseif event == "CHAT_MSG_MONSTER_EMOTE" then
			if arg1 == DBM_CHROMAGGUS_FRENZY_EXPR and arg2 == DBM_CHROMAGGUS_CHROMAGGUS then
				...
				DBM.StartStatusBarTimer(15, "Frenzy", "Interface\\Icons\\Ability_Druid_ChallangingRoar");
			...
			elseif arg1 == DBM_CHROMAGGUS_VULNERABILITY_EXPR and arg2 == DBM_CHROMAGGUS_CHROMAGGUS then
				if DBM.AddOns.Chromaggus.Options.Vulnerability then
					...
					if DBM.AddOns.Chromaggus.InCombat == true then
	...
	["OnCombatEnd"] = function()
		DBM.AddOns.Chromaggus.Breath1 = DBM_CHROMAGGUS_BREATH_1;
		DBM.AddOns.Chromaggus.Breath2 = DBM_CHROMAGGUS_BREATH_2;
		DBM.AddOns.Chromaggus.Vulnerability = "";
	end,
};
