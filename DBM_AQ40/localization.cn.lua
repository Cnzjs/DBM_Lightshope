...
-- 1. Skeram
	...
	DBM_SKERAM_YELL1				= "Are you so eager to die? I would be happy to accomodate you.";
	DBM_SKERAM_YELL2				= "Cower mortals! The age of darkness is at hand.";
	DBM_SKERAM_YELL3				= "Tremble! The end is upon you.";
...
-- 2. Three Bugs (Vem & Co)
	...
	DBM_THREEBUGS_FEAR_EXPR			= "([^%s]+)受([^%s]+)恐慌效果的影响。";
	DBM_THREEBUGS_FEAR_EXPR2		= "亚尔基公主的恐慌";
	DBM_THREEBUGS_FEAR_ANNOUNCE		= "*** 亚尔基公主 - %d秒后群恐 ***";
	DBM_THREEBUGS_CASTHEAL_EXPR		= "亚尔基公主开始施放强效治疗术。";
	DBM_THREEBUGS_CASTHEAL_ANNOUNCE	= "*** 亚尔基公主 - 正在治疗 ***";
	
	DBM_SBT["Great Heal Cast"] 		= "强效治疗术";
	DBM_SBT["Yauj Fear"] 			= "群恐";


-- 3. Battleguard Sartura
	DBM_SARTURA_NAME				= "沙尔图拉"
	DBM_SARTURA_DESCRIPTION			= "警报旋风斩"
	DBM_SARTURA_YELL_START			= "You will be judged for defiling these sacred grounds! The laws of the Ancients will not be challenged! Trespassers will be annihilated!";
	...
	DBM_SBT["Enrage"]				= "激怒";
	DBM_SBT["3_NextWhirlwind"]		= "下一次旋风斩";
...
-- 5. Huhuran
	...
	DBM_HUHURAN_WYVERN_REGEXP2			= "哈霍兰公主的翼龙钉刺被";
	DBM_HUHURAN_FRENZY					= "%s goes into a berserker rage!";
	DBM_HUHURAN_FRENZY_ANNOUNCE			= "*** 狂暴 - RUSH阶段 ***";
	DBM_HUHURAN_HUHURAN					= "哈霍兰公主";
	DBM_HUHURAN_NOXIOUS_EXPR			= "受到了致命剧毒效果的影响";
	DBM_HUHURAN_CRAZY					= "%s goes into a killing frenzy!";
	DBM_HUHURAN_CRAZY_ANNOUNCE			= "*** 疯狂 - 立即宁神 ***";
	
	DBM_SBT["Wyvern Sting Cooldown"]	= "翼龙钉刺";
	DBM_SBT["6_Noxious"]				= "致命剧毒";
...
-- 6. Twin Emperors
	...
	DBM_TWINEMPS_YELL1				= "Look brother, fresh blood!";
	DBM_TWINEMPS_YELL2				= "Join me brother, there is blood to be shed!";
	DBM_TWINEMPS_YELL3				= "Ah, lambs to the slaughter!";
	DBM_TWINEMPS_YELL4				= "Let none survive!";
	...
	DBM_TWINEMPS_CAST_SPELL_1		= "获得了双子传送的效果。";

	DBM_TWINEMPS_VEKNILASH			= "维克尼拉斯大帝";
	DBM_TWINEMPS_VEKLOR				= "维克洛尔大帝";
	
	DBM_TWINEMPS_EXPLODE_EXPR 		= "受到了爆炸虫效果的影响";
